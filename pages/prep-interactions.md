...
In this unit, we will start to use sequence diagrams. They are useful to study interactions between your system components.

## Mandatory Preparation

Read carefully through the script on sequence diagrams below.

[pdf-embedder url="https://www.iik.ntnu.no/ttm4115/wp-content/uploads/2018/02/ttm4115-unit-5-v-2018-1.pdf"]

[Direct Download Link](https://www.iik.ntnu.no/ttm4115/wp-content/uploads/2018/02/ttm4115-unit-5-v-2018-1.pdf)

This is a new script, so there may be errors or you may have comments and questions. Please post them to Piazza!
...
---
type: figure
source: figures/interactions/intuition.svg
caption: "A sequence diagram showing a simple interaction"
---
...
![image](figures/car-key.pdf){width="6cm"}
...
![image](figures/home-system.pdf){width="\linewidth"}
...
![image](figures/math-pow.pdf){width="4cm"}

Fig. [\[fig-pow\]](#fig-pow){reference-type="ref" reference="fig-pow"}
shows an example of a sequence diagram that shows the communication
...
![image](figures/math-pow-3.pdf){width="5cm"}
...
![image](figures/math-pow-2.pdf){width="5cm"}
...
![image](figures/create-destroy.pdf){width="5cm"}
...
diagrams can quickly grow, and a naÔve attempt to cover all scenarios
...
![image](figures/alt.pdf){width="\textwidth"}
...
![image](figures/opt-1.pdf){width="8cm"}
...
![image](figures/loop-1.pdf){width="5cm"}
...
![image](figures/assert-neg.pdf){width="10cm"}
...
![image](figures/ref-1.pdf){width="7cm"}
...
![From UML \@Class Book](figures/timing.pdf){width="\linewidth"}
...
![image](figures/ordering-lifeline.pdf){width="2cm"}
...
![Despite the position on their respective lifelines, events $?A$ and
$?B$ are not in any order in this
diagram.](figures/ex-11.pdf){width="5cm"}
...
![image](figures/ex-12.pdf){width="\linewidth"}
...
![image](figures/ex-1.pdf){width="\linewidth"}
...
![image](figures/ex-2.pdf){width="\linewidth"}
...
![image](figures/ex-3.pdf){width="\linewidth"}
...
![image](figures/ex-3-2.pdf){width="\linewidth"}
...
![image](figures/lossy-12.pdf){width="\linewidth"}
...
![image](figures/lossy-3.pdf){width="\linewidth"}
...
![image](figures/ex-6.pdf){width="\linewidth"}
...
![image](figures/ex-7.pdf){width="\linewidth"}
...
![image](figures/ex-8.pdf){width="\linewidth"}
...
![image](figures/ex-9.pdf){width="5cm"}
...
![image](figures/ex-91.pdf){width="\linewidth"}
