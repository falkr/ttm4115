...
Store all your documents under the 'Shared' section of your team's channel. For **each unit, you first need to create a folder, for example Unit01** for the first unit.
...
- Find the template for the team reflection document in the 'General/Unit01 ...' channel on Teams. It has the name `Team Reflection Template.docx`.
